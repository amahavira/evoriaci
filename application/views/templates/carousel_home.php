<div class="container">
	<div id="jssor_1" style="position:relative; margin:30px auto; top:0px; left:0px; width:980px; height:140px; overflow:hidden; visibility:hidden;">
		<div data-u="slides" style="cursor:default; position:relative; top:0px; left:0px; width:980px; height:180px; overflow:hidden;">

			<!-- Slide -->
			<script src="<?php echo base_url('assets/js/jssor.slider-28.0.0.min.js') ?>" type="text/javascript"></script>
			...
			<div>
				<img data-u="image" src="<?php echo base_url('assets/gambar/promo/wedding1.png') ?>" />
			</div>
			<div>
				<img data-u="image" src="<?php echo base_url('assets/gambar/promo/wedding1.png') ?>" />
			</div>
