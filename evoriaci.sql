...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2020 at 05:57 AM
...
INSERT INTO `pemesanan` (`id`, `id_jasa`, `id_seller`, `id_user`, `tgl_order`, `tgl_acara`, `status`, `bukti_bayar`) VALUES
(25, 168, 24, 20, '2020-10-16', '2020-10-24', 5, 'Contoh_Bukti_TF1.png'),
(26, 173, 24, 25, '2020-10-16', '2020-10-23', 5, 'Contoh_Bukti_TF.png'),
(27, 168, 24, 25, '2020-10-16', '2020-10-30', 6, ''),
(28, 172, 21, 25, '2020-10-16', '2020-10-24', 0, ''),
(29, 172, 21, 25, '2020-10-16', '2020-10-31', 0, ''),
(30, 168, 24, 25, '2020-10-19', '2020-11-19', 0, ''),
(31, 172, 21, 25, '2020-10-19', '2020-10-31', 0, '');
...
INSERT INTO `users` (`id`, `name`, `nohp`, `email`, `pekerjaan`, `image`, `password`, `role_id`, `is_active`, `nama_bisnis`, `tentang`, `alamat`, `kota`, `medsos`, `npwp`, `date_created`) VALUES
(14, 'Aditya Putra Irawan', '081260176831', 'emailnya.aditni@gmail.com', '', 'Foto_Formal_BG_BIRU1.jpg', '$2y$10$rIZvce.CsdzwE1cpCrK3texd0fEYBu4IhZfOoQhBhDwmiM4vIXghO', 1, 1, '', '', '', '', '', '', 1595954496),
(18, 'Aditya Putra Irawan', '081260176831', 'aditputrasiro@gmail.com', '', '5.png', '$2y$10$Ol.p1zHqGbcB6yzGzXE3UeEroF0od5/pu3Re9zUhBaeULTzltIoL.', 1, 1, '', '', '', '', '', '', 1595991605),
(19, 'Aditya Mahavira Steven', '081258963548', 'amahavira@gmail.com', '', 'IMG_20170115_233052_264.jpg', '$2y$10$RtIWxtW2XAzLjAiIfQklr.JNyVXayUdwRQzKqhziozOhjn.tNQTNi', 1, 1, '', '', '', '', '', '', 1596967265),
(20, 'Muhammad Rasyid Shadiq', '082293641087', 'rasyidshadiq97@gmail.com', 'Karyawan', 'default.png', '$2y$10$T6ypha2aR5XQftI3h/nCsuZjVOoTLNdxmrnxPluz5Gvtxn5ArHPEi', 2, 1, '', '', 'Yogyakarta', '', '', '', 1599142022),
(21, 'Aditya Mahavira', '089520892008', 'amahavira@rocketmail.com', '', 'default.png', '$2y$10$kRA3o4ZueeRo100EIIYeQOiYtJu8PHbeT3Hd3JCQxQZS6MZks9aYq', 4, 1, 'Adot EO', 'Bergerak di bidang Macam-macam', 'Yogyakarta', 'Sleman', 'IG : @eocimtah', '', 1600479121),
(22, 'Aditya Mahavira', '089520892008', 'tjah001@gmail.com', '', 'default.png', '$2y$10$yENhbWgf3scyVPd3yber7usjw876pp/1PJ8E2DBULb.lzNJ80QIJa', 4, 1, 'Project Adot', 'Bergerak di bidang Musik', 'Yogyakarta', 'Sleman', 'IG : @ProjectAdot', '', 1600483783),
(24, 'Fikri Almakmuri', '081258963548', 'alfikripriyagung@gmail.com', 'Marketing', 'music1.jpg', '$2y$10$JfHHMLDiDHCz2yC.kpihj.4ZiECGCfv0H8uxZkyoKLU9KNIt6l2We', 4, 1, 'Makmur EO', 'Makmur EO', 'Yogyakarta', 'Sleman', '@makmureo', 'contohnpwp.pdf', 1600953180),
(25, 'Muhammad Yasin Deru Saputra', '081227272672', 'mydsaputra@gmail.com', 'Karyawan', 'default.png', '$2y$10$A4hlbghCUH5dsL39l1sa6Oov4BRzPcy3pJJS4TZDeSomfXRxUx0Vu', 2, 1, '', '', 'Kalasan', '', '', '', 1601954798);
...
(10, 4, 'Profile', 'user/profile_seller', 'fas fa-fw fa-user-circle', 1),
(12, 2, 'Home', 'user/evoria', 'fas fa-fw fa-home', 1),
(13, 2, 'Vendor', 'user/evoria/index#vendor', 'fas fa-fw fa-store', 1),
(14, 2, 'Inspiration', 'user/inspiration', 'fas fa-fw fa-images', 1),
(15, 4, 'Data Tentang Bisnis', 'user/data_bisnis', 'fas fa-fw fa-table', 0),
(16, 4, 'Halaman Bisnis', 'user/halaman_bisnis', 'fas fa-fw fa-store', 1),
(17, 4, 'Edit Profile', 'user/edit_profile_seller', 'fas fa-fw fa-user-edit', 0),
(18, 4, 'Halaman Pesanan', 'user/pesanan', 'fas fa-fw fa-boxes', 1),
